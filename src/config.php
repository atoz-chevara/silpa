...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'HAtrC2CdIskgaHVk', // Random key for encryption
    ...
    "ADMIN_PASSWORD" => "F4t4moregana", // Administrator password
    ...
    "USER_LEVEL_PRIV_TABLE" => "`permissions`",
