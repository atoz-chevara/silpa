...
class PertanggungjawabanAdd extends Pertanggungjawaban
{
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->rq_apbkpert->Upload->DbValue = null;
        $this->rq_apbkpert->OldValue = $this->rq_apbkpert->Upload->DbValue;
        $this->rq_apbkpert->CurrentValue = null; // Clear file related field
        $this->bap_apbkpert->Upload->DbValue = null;
        $this->bap_apbkpert->OldValue = $this->bap_apbkpert->Upload->DbValue;
        $this->bap_apbkpert->CurrentValue = null; // Clear file related field
        ...
        $this->softcopy_rqanun->Upload->DbValue = null;
        $this->softcopy_rqanun->OldValue = $this->softcopy_rqanun->Upload->DbValue;
        $this->softcopy_rqanun->CurrentValue = null; // Clear file related field
    ...
    protected function newRow()
    {
        ...
        $row['rq_apbkpert'] = $this->rq_apbkpert->Upload->DbValue;
        $row['bap_apbkpert'] = $this->bap_apbkpert->Upload->DbValue;
        ...
        $row['softcopy_rqanun'] = $this->softcopy_rqanun->Upload->DbValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->rq_apbkpert->Visible && !$this->rq_apbkpert->Upload->KeepFile) {
            $this->rq_apbkpert->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->bap_apbkpert->Visible && !$this->bap_apbkpert->Upload->KeepFile) {
            $this->bap_apbkpert->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->softcopy_rqanun->Visible && !$this->softcopy_rqanun->Upload->KeepFile) {
            $this->softcopy_rqanun->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->rq_apbkpert->Visible && !$this->rq_apbkpert->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->rq_apbkpert->Upload->FileName)) {
                ...
                $this->rq_apbkpert->setDbValueDef($rsnew, $this->rq_apbkpert->Upload->FileName, null, false);
            }
        }
        if ($this->bap_apbkpert->Visible && !$this->bap_apbkpert->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->bap_apbkpert->Upload->FileName)) {
                ...
                $this->bap_apbkpert->setDbValueDef($rsnew, $this->bap_apbkpert->Upload->FileName, null, false);
            }
        }
        if ($this->risalah_sidang->Visible && !$this->risalah_sidang->Upload->KeepFile) {
        ...
        if ($this->softcopy_rqanun->Visible && !$this->softcopy_rqanun->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->softcopy_rqanun->Upload->FileName)) {
                ...
                $this->softcopy_rqanun->setDbValueDef($rsnew, $this->softcopy_rqanun->Upload->FileName, null, false);
            }
        }
