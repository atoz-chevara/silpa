 ...
 * Page class
 */
class EvaluatorsDelete extends Evaluators
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EvaluatorsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("evaluatorslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("evaluatorslist"); // Return to list
            return;
        }
