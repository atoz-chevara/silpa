 ...
 * Page class
 */
class EvaluatorsView extends Evaluators
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EvaluatorsView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idd_evaluator") ?? Route("idd_evaluator")) !== null) {
            $this->RecKey["idd_evaluator"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        $this->idd_evaluator->setVisibility();
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("idd_evaluator") ?? Route("idd_evaluator")) !== null) {
                ...
                $this->RecKey["idd_evaluator"] = $this->idd_evaluator->QueryStringValue;
            } elseif (Post("idd_evaluator") !== null) {
                $this->idd_evaluator->setFormValue(Post("idd_evaluator"));
                $this->RecKey["idd_evaluator"] = $this->idd_evaluator->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->idd_evaluator->setQueryStringValue($keyValue);
                $this->RecKey["idd_evaluator"] = $this->idd_evaluator->QueryStringValue;
            } else {
                $returnUrl = "evaluatorslist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "evaluatorslist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "evaluatorslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
