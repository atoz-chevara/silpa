 ...
 * Page class
 */
class ApbkpDelete extends Apbkp
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ApbkpDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("apbkplist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("apbkplist"); // Return to list
                return;
            }
        }
