...
class EvaluasiAdd extends Evaluasi
{
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->rpjmd->Upload->DbValue = null;
        $this->rpjmd->OldValue = $this->rpjmd->Upload->DbValue;
        $this->rpjmd->CurrentValue = null; // Clear file related field
        $this->rkpk->Upload->DbValue = null;
        $this->rkpk->OldValue = $this->rkpk->Upload->DbValue;
        $this->rkpk->CurrentValue = null; // Clear file related field
        $this->skd_rkuappas->Upload->DbValue = null;
        $this->skd_rkuappas->OldValue = $this->skd_rkuappas->Upload->DbValue;
        $this->skd_rkuappas->CurrentValue = null; // Clear file related field
        $this->kua->Upload->DbValue = null;
        $this->kua->OldValue = $this->kua->Upload->DbValue;
        $this->kua->CurrentValue = null; // Clear file related field
        $this->ppas->Upload->DbValue = null;
        $this->ppas->OldValue = $this->ppas->Upload->DbValue;
        $this->ppas->CurrentValue = null; // Clear file related field
        $this->skd_rqanun->Upload->DbValue = null;
        $this->skd_rqanun->OldValue = $this->skd_rqanun->Upload->DbValue;
        $this->skd_rqanun->CurrentValue = null; // Clear file related field
        $this->nota_keuangan->Upload->DbValue = null;
        $this->nota_keuangan->OldValue = $this->nota_keuangan->Upload->DbValue;
        $this->nota_keuangan->CurrentValue = null; // Clear file related field
        $this->pengantar_nota->Upload->DbValue = null;
        $this->pengantar_nota->OldValue = $this->pengantar_nota->Upload->DbValue;
        $this->pengantar_nota->CurrentValue = null; // Clear file related field
        ...
        $this->bap_apbk->Upload->DbValue = null;
        $this->bap_apbk->OldValue = $this->bap_apbk->Upload->DbValue;
        $this->bap_apbk->CurrentValue = null; // Clear file related field
        $this->rq_apbk->Upload->DbValue = null;
        $this->rq_apbk->OldValue = $this->rq_apbk->Upload->DbValue;
        $this->rq_apbk->CurrentValue = null; // Clear file related field
        $this->rp_penjabaran->Upload->DbValue = null;
        $this->rp_penjabaran->OldValue = $this->rp_penjabaran->Upload->DbValue;
        $this->rp_penjabaran->CurrentValue = null; // Clear file related field
        $this->jadwal_proses->Upload->DbValue = null;
        $this->jadwal_proses->OldValue = $this->jadwal_proses->Upload->DbValue;
        $this->jadwal_proses->CurrentValue = null; // Clear file related field
        $this->sinkron_kebijakan->Upload->DbValue = null;
        $this->sinkron_kebijakan->OldValue = $this->sinkron_kebijakan->Upload->DbValue;
        $this->sinkron_kebijakan->CurrentValue = null; // Clear file related field
        $this->konsistensi_program->Upload->DbValue = null;
        $this->konsistensi_program->OldValue = $this->konsistensi_program->Upload->DbValue;
        $this->konsistensi_program->CurrentValue = null; // Clear file related field
        $this->alokasi_pendidikan->Upload->DbValue = null;
        $this->alokasi_pendidikan->OldValue = $this->alokasi_pendidikan->Upload->DbValue;
        $this->alokasi_pendidikan->CurrentValue = null; // Clear file related field
        $this->alokasi_kesehatan->Upload->DbValue = null;
        $this->alokasi_kesehatan->OldValue = $this->alokasi_kesehatan->Upload->DbValue;
        $this->alokasi_kesehatan->CurrentValue = null; // Clear file related field
        $this->alokasi_belanja->Upload->DbValue = null;
        $this->alokasi_belanja->OldValue = $this->alokasi_belanja->Upload->DbValue;
        $this->alokasi_belanja->CurrentValue = null; // Clear file related field
        $this->bak_kegiatan->Upload->DbValue = null;
        $this->bak_kegiatan->OldValue = $this->bak_kegiatan->Upload->DbValue;
        $this->bak_kegiatan->CurrentValue = null; // Clear file related field
        $this->softcopy_rka->Upload->DbValue = null;
        $this->softcopy_rka->OldValue = $this->softcopy_rka->Upload->DbValue;
        $this->softcopy_rka->CurrentValue = null; // Clear file related field
        $this->otsus->Upload->DbValue = null;
        $this->otsus->OldValue = $this->otsus->Upload->DbValue;
        $this->otsus->CurrentValue = null; // Clear file related field
        $this->qanun_perbup->Upload->DbValue = null;
        $this->qanun_perbup->OldValue = $this->qanun_perbup->Upload->DbValue;
        $this->qanun_perbup->CurrentValue = null; // Clear file related field
        $this->tindak_apbkp->Upload->DbValue = null;
        $this->tindak_apbkp->OldValue = $this->tindak_apbkp->Upload->DbValue;
        $this->tindak_apbkp->CurrentValue = null; // Clear file related field
    ...
    protected function newRow()
    {
        ...
        $row['rpjmd'] = $this->rpjmd->Upload->DbValue;
        $row['rkpk'] = $this->rkpk->Upload->DbValue;
        $row['skd_rkuappas'] = $this->skd_rkuappas->Upload->DbValue;
        $row['kua'] = $this->kua->Upload->DbValue;
        $row['ppas'] = $this->ppas->Upload->DbValue;
        $row['skd_rqanun'] = $this->skd_rqanun->Upload->DbValue;
        $row['nota_keuangan'] = $this->nota_keuangan->Upload->DbValue;
        $row['pengantar_nota'] = $this->pengantar_nota->Upload->DbValue;
        $row['risalah_sidang'] = $this->risalah_sidang->Upload->DbValue;
        $row['bap_apbk'] = $this->bap_apbk->Upload->DbValue;
        $row['rq_apbk'] = $this->rq_apbk->Upload->DbValue;
        $row['rp_penjabaran'] = $this->rp_penjabaran->Upload->DbValue;
        $row['jadwal_proses'] = $this->jadwal_proses->Upload->DbValue;
        $row['sinkron_kebijakan'] = $this->sinkron_kebijakan->Upload->DbValue;
        $row['konsistensi_program'] = $this->konsistensi_program->Upload->DbValue;
        $row['alokasi_pendidikan'] = $this->alokasi_pendidikan->Upload->DbValue;
        $row['alokasi_kesehatan'] = $this->alokasi_kesehatan->Upload->DbValue;
        $row['alokasi_belanja'] = $this->alokasi_belanja->Upload->DbValue;
        $row['bak_kegiatan'] = $this->bak_kegiatan->Upload->DbValue;
        $row['softcopy_rka'] = $this->softcopy_rka->Upload->DbValue;
        $row['otsus'] = $this->otsus->Upload->DbValue;
        $row['qanun_perbup'] = $this->qanun_perbup->Upload->DbValue;
        $row['tindak_apbkp'] = $this->tindak_apbkp->Upload->DbValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->rpjmd->Visible && !$this->rpjmd->Upload->KeepFile) {
            $this->rpjmd->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->rkpk->Visible && !$this->rkpk->Upload->KeepFile) {
            $this->rkpk->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->skd_rkuappas->Visible && !$this->skd_rkuappas->Upload->KeepFile) {
            $this->skd_rkuappas->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->kua->Visible && !$this->kua->Upload->KeepFile) {
            $this->kua->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->ppas->Visible && !$this->ppas->Upload->KeepFile) {
            $this->ppas->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->skd_rqanun->Visible && !$this->skd_rqanun->Upload->KeepFile) {
            $this->skd_rqanun->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->nota_keuangan->Visible && !$this->nota_keuangan->Upload->KeepFile) {
            $this->nota_keuangan->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->pengantar_nota->Visible && !$this->pengantar_nota->Upload->KeepFile) {
            $this->pengantar_nota->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->bap_apbk->Visible && !$this->bap_apbk->Upload->KeepFile) {
            $this->bap_apbk->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->rq_apbk->Visible && !$this->rq_apbk->Upload->KeepFile) {
            $this->rq_apbk->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->rp_penjabaran->Visible && !$this->rp_penjabaran->Upload->KeepFile) {
            $this->rp_penjabaran->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->jadwal_proses->Visible && !$this->jadwal_proses->Upload->KeepFile) {
            $this->jadwal_proses->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->sinkron_kebijakan->Visible && !$this->sinkron_kebijakan->Upload->KeepFile) {
            $this->sinkron_kebijakan->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->konsistensi_program->Visible && !$this->konsistensi_program->Upload->KeepFile) {
            $this->konsistensi_program->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->alokasi_pendidikan->Visible && !$this->alokasi_pendidikan->Upload->KeepFile) {
            $this->alokasi_pendidikan->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->alokasi_kesehatan->Visible && !$this->alokasi_kesehatan->Upload->KeepFile) {
            $this->alokasi_kesehatan->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->alokasi_belanja->Visible && !$this->alokasi_belanja->Upload->KeepFile) {
            $this->alokasi_belanja->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->bak_kegiatan->Visible && !$this->bak_kegiatan->Upload->KeepFile) {
            $this->bak_kegiatan->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->softcopy_rka->Visible && !$this->softcopy_rka->Upload->KeepFile) {
            $this->softcopy_rka->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->otsus->Visible && !$this->otsus->Upload->KeepFile) {
            $this->otsus->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->qanun_perbup->Visible && !$this->qanun_perbup->Upload->KeepFile) {
            $this->qanun_perbup->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->tindak_apbkp->Visible && !$this->tindak_apbkp->Upload->KeepFile) {
            $this->tindak_apbkp->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->surat_pengantar->Visible && !$this->surat_pengantar->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->surat_pengantar->Upload->FileName)) {
                ...
                $this->surat_pengantar->setDbValueDef($rsnew, $this->surat_pengantar->Upload->FileName, "", false);
            }
        }
        if ($this->rpjmd->Visible && !$this->rpjmd->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->rpjmd->Upload->FileName)) {
                ...
                $this->rpjmd->setDbValueDef($rsnew, $this->rpjmd->Upload->FileName, "", false);
            }
        }
        if ($this->rkpk->Visible && !$this->rkpk->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->rkpk->Upload->FileName)) {
                ...
                $this->rkpk->setDbValueDef($rsnew, $this->rkpk->Upload->FileName, "", false);
            }
        }
        if ($this->skd_rkuappas->Visible && !$this->skd_rkuappas->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->skd_rkuappas->Upload->FileName)) {
                ...
                $this->skd_rkuappas->setDbValueDef($rsnew, $this->skd_rkuappas->Upload->FileName, "", false);
            }
        }
        if ($this->kua->Visible && !$this->kua->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->kua->Upload->FileName)) {
                ...
                $this->kua->setDbValueDef($rsnew, $this->kua->Upload->FileName, "", false);
            }
        }
        if ($this->ppas->Visible && !$this->ppas->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->ppas->Upload->FileName)) {
                ...
                $this->ppas->setDbValueDef($rsnew, $this->ppas->Upload->FileName, "", false);
            }
        }
        if ($this->skd_rqanun->Visible && !$this->skd_rqanun->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->skd_rqanun->Upload->FileName)) {
                ...
                $this->skd_rqanun->setDbValueDef($rsnew, $this->skd_rqanun->Upload->FileName, "", false);
            }
        }
        if ($this->nota_keuangan->Visible && !$this->nota_keuangan->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->nota_keuangan->Upload->FileName)) {
                ...
                $this->nota_keuangan->setDbValueDef($rsnew, $this->nota_keuangan->Upload->FileName, "", false);
            }
        }
        if ($this->pengantar_nota->Visible && !$this->pengantar_nota->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->pengantar_nota->Upload->FileName)) {
                ...
                $this->pengantar_nota->setDbValueDef($rsnew, $this->pengantar_nota->Upload->FileName, "", false);
            }
        }
        if ($this->risalah_sidang->Visible && !$this->risalah_sidang->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->risalah_sidang->Upload->FileName)) {
                ...
                $this->risalah_sidang->setDbValueDef($rsnew, $this->risalah_sidang->Upload->FileName, "", false);
            }
        }
        if ($this->bap_apbk->Visible && !$this->bap_apbk->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->bap_apbk->Upload->FileName)) {
                ...
                $this->bap_apbk->setDbValueDef($rsnew, $this->bap_apbk->Upload->FileName, "", false);
            }
        }
        if ($this->rq_apbk->Visible && !$this->rq_apbk->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->rq_apbk->Upload->FileName)) {
                ...
                $this->rq_apbk->setDbValueDef($rsnew, $this->rq_apbk->Upload->FileName, "", false);
            }
        }
        if ($this->rp_penjabaran->Visible && !$this->rp_penjabaran->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->rp_penjabaran->Upload->FileName)) {
                ...
                $this->rp_penjabaran->setDbValueDef($rsnew, $this->rp_penjabaran->Upload->FileName, "", false);
            }
        }
        if ($this->jadwal_proses->Visible && !$this->jadwal_proses->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->jadwal_proses->Upload->FileName)) {
                ...
                $this->jadwal_proses->setDbValueDef($rsnew, $this->jadwal_proses->Upload->FileName, "", false);
            }
        }
        if ($this->sinkron_kebijakan->Visible && !$this->sinkron_kebijakan->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->sinkron_kebijakan->Upload->FileName)) {
                ...
                $this->sinkron_kebijakan->setDbValueDef($rsnew, $this->sinkron_kebijakan->Upload->FileName, "", false);
            }
        }
        if ($this->konsistensi_program->Visible && !$this->konsistensi_program->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->konsistensi_program->Upload->FileName)) {
                ...
                $this->konsistensi_program->setDbValueDef($rsnew, $this->konsistensi_program->Upload->FileName, "", false);
            }
        }
        if ($this->alokasi_pendidikan->Visible && !$this->alokasi_pendidikan->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->alokasi_pendidikan->Upload->FileName)) {
                ...
                $this->alokasi_pendidikan->setDbValueDef($rsnew, $this->alokasi_pendidikan->Upload->FileName, "", false);
            }
        }
        if ($this->alokasi_kesehatan->Visible && !$this->alokasi_kesehatan->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->alokasi_kesehatan->Upload->FileName)) {
                ...
                $this->alokasi_kesehatan->setDbValueDef($rsnew, $this->alokasi_kesehatan->Upload->FileName, "", false);
            }
        }
        if ($this->alokasi_belanja->Visible && !$this->alokasi_belanja->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->alokasi_belanja->Upload->FileName)) {
                ...
                $this->alokasi_belanja->setDbValueDef($rsnew, $this->alokasi_belanja->Upload->FileName, "", false);
            }
        }
        if ($this->bak_kegiatan->Visible && !$this->bak_kegiatan->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->bak_kegiatan->Upload->FileName)) {
                ...
                $this->bak_kegiatan->setDbValueDef($rsnew, $this->bak_kegiatan->Upload->FileName, "", false);
            }
        }
        if ($this->softcopy_rka->Visible && !$this->softcopy_rka->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->softcopy_rka->Upload->FileName)) {
                ...
                $this->softcopy_rka->setDbValueDef($rsnew, $this->softcopy_rka->Upload->FileName, "", false);
            }
        }
        if ($this->otsus->Visible && !$this->otsus->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->otsus->Upload->FileName)) {
                ...
                $this->otsus->setDbValueDef($rsnew, $this->otsus->Upload->FileName, "", false);
            }
        }
        if ($this->qanun_perbup->Visible && !$this->qanun_perbup->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->qanun_perbup->Upload->FileName)) {
                ...
                $this->qanun_perbup->setDbValueDef($rsnew, $this->qanun_perbup->Upload->FileName, "", false);
            }
        }
        if ($this->tindak_apbkp->Visible && !$this->tindak_apbkp->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->tindak_apbkp->Upload->FileName)) {
                ...
                $this->tindak_apbkp->setDbValueDef($rsnew, $this->tindak_apbkp->Upload->FileName, "", false);
            }
        }
