...
class RapbkAdd extends Rapbk
{
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "rapbkview") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->file_01->Upload->DbValue = null;
        $this->file_01->OldValue = $this->file_01->Upload->DbValue;
        $this->file_01->CurrentValue = null; // Clear file related field
        $this->file_02->Upload->DbValue = null;
        $this->file_02->OldValue = $this->file_02->Upload->DbValue;
        $this->file_02->CurrentValue = null; // Clear file related field
        $this->file_03->Upload->DbValue = null;
        $this->file_03->OldValue = $this->file_03->Upload->DbValue;
        $this->file_03->CurrentValue = null; // Clear file related field
        $this->file_04->Upload->DbValue = null;
        $this->file_04->OldValue = $this->file_04->Upload->DbValue;
        $this->file_04->CurrentValue = null; // Clear file related field
        $this->file_05->Upload->DbValue = null;
        $this->file_05->OldValue = $this->file_05->Upload->DbValue;
        $this->file_05->CurrentValue = null; // Clear file related field
        $this->file_06->Upload->DbValue = null;
        $this->file_06->OldValue = $this->file_06->Upload->DbValue;
        $this->file_06->CurrentValue = null; // Clear file related field
        $this->file_07->Upload->DbValue = null;
        $this->file_07->OldValue = $this->file_07->Upload->DbValue;
        $this->file_07->CurrentValue = null; // Clear file related field
        $this->file_08->Upload->DbValue = null;
        $this->file_08->OldValue = $this->file_08->Upload->DbValue;
        $this->file_08->CurrentValue = null; // Clear file related field
        $this->file_09->Upload->DbValue = null;
        $this->file_09->OldValue = $this->file_09->Upload->DbValue;
        $this->file_09->CurrentValue = null; // Clear file related field
        $this->file_10->Upload->DbValue = null;
        $this->file_10->OldValue = $this->file_10->Upload->DbValue;
        $this->file_10->CurrentValue = null; // Clear file related field
        $this->file_11->Upload->DbValue = null;
        $this->file_11->OldValue = $this->file_11->Upload->DbValue;
        $this->file_11->CurrentValue = null; // Clear file related field
        ...
        $this->file_15->Upload->DbValue = null;
        $this->file_15->OldValue = $this->file_15->Upload->DbValue;
        $this->file_15->CurrentValue = null; // Clear file related field
        $this->file_16->Upload->DbValue = null;
        $this->file_16->OldValue = $this->file_16->Upload->DbValue;
        $this->file_16->CurrentValue = null; // Clear file related field
        $this->file_17->Upload->DbValue = null;
        $this->file_17->OldValue = $this->file_17->Upload->DbValue;
        $this->file_17->CurrentValue = null; // Clear file related field
        $this->file_18->Upload->DbValue = null;
        $this->file_18->OldValue = $this->file_18->Upload->DbValue;
        $this->file_18->CurrentValue = null; // Clear file related field
        $this->file_19->Upload->DbValue = null;
        $this->file_19->OldValue = $this->file_19->Upload->DbValue;
        $this->file_19->CurrentValue = null; // Clear file related field
        $this->file_20->Upload->DbValue = null;
        $this->file_20->OldValue = $this->file_20->Upload->DbValue;
        $this->file_20->CurrentValue = null; // Clear file related field
        $this->file_21->Upload->DbValue = null;
        $this->file_21->OldValue = $this->file_21->Upload->DbValue;
        $this->file_21->CurrentValue = null; // Clear file related field
        $this->file_22->Upload->DbValue = null;
        $this->file_22->OldValue = $this->file_22->Upload->DbValue;
        $this->file_22->CurrentValue = null; // Clear file related field
        $this->file_23->Upload->DbValue = null;
        $this->file_23->OldValue = $this->file_23->Upload->DbValue;
        $this->file_23->CurrentValue = null; // Clear file related field
        $this->file_24->Upload->DbValue = null;
        $this->file_24->OldValue = $this->file_24->Upload->DbValue;
    ...
    protected function newRow()
    {
        ...
        $row['file_01'] = $this->file_01->Upload->DbValue;
        $row['file_02'] = $this->file_02->Upload->DbValue;
        $row['file_03'] = $this->file_03->Upload->DbValue;
        $row['file_04'] = $this->file_04->Upload->DbValue;
        $row['file_05'] = $this->file_05->Upload->DbValue;
        $row['file_06'] = $this->file_06->Upload->DbValue;
        $row['file_07'] = $this->file_07->Upload->DbValue;
        $row['file_08'] = $this->file_08->Upload->DbValue;
        $row['file_09'] = $this->file_09->Upload->DbValue;
        ...
        $row['file_17'] = $this->file_17->Upload->DbValue;
        $row['file_18'] = $this->file_18->Upload->DbValue;
        $row['file_19'] = $this->file_19->Upload->DbValue;
        $row['file_20'] = $this->file_20->Upload->DbValue;
        $row['file_21'] = $this->file_21->Upload->DbValue;
        $row['file_22'] = $this->file_22->Upload->DbValue;
        $row['file_23'] = $this->file_23->Upload->DbValue;
        $row['file_24'] = $this->file_24->Upload->DbValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->file_01->Visible && !$this->file_01->Upload->KeepFile) {
            $this->file_01->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_02->Visible && !$this->file_02->Upload->KeepFile) {
            $this->file_02->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_03->Visible && !$this->file_03->Upload->KeepFile) {
            $this->file_03->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_04->Visible && !$this->file_04->Upload->KeepFile) {
            $this->file_04->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_05->Visible && !$this->file_05->Upload->KeepFile) {
            $this->file_05->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_06->Visible && !$this->file_06->Upload->KeepFile) {
            $this->file_06->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_07->Visible && !$this->file_07->Upload->KeepFile) {
            $this->file_07->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_08->Visible && !$this->file_08->Upload->KeepFile) {
            $this->file_08->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_09->Visible && !$this->file_09->Upload->KeepFile) {
            $this->file_09->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_10->Visible && !$this->file_10->Upload->KeepFile) {
            $this->file_10->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_11->Visible && !$this->file_11->Upload->KeepFile) {
            $this->file_11->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_12->Visible && !$this->file_12->Upload->KeepFile) {
            $this->file_12->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_14->Visible && !$this->file_14->Upload->KeepFile) {
            $this->file_14->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_15->Visible && !$this->file_15->Upload->KeepFile) {
            $this->file_15->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_16->Visible && !$this->file_16->Upload->KeepFile) {
            $this->file_16->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_17->Visible && !$this->file_17->Upload->KeepFile) {
            $this->file_17->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_18->Visible && !$this->file_18->Upload->KeepFile) {
            $this->file_18->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_19->Visible && !$this->file_19->Upload->KeepFile) {
            $this->file_19->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_20->Visible && !$this->file_20->Upload->KeepFile) {
            $this->file_20->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_21->Visible && !$this->file_21->Upload->KeepFile) {
            $this->file_21->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_22->Visible && !$this->file_22->Upload->KeepFile) {
            $this->file_22->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_23->Visible && !$this->file_23->Upload->KeepFile) {
            $this->file_23->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_24->Visible && !$this->file_24->Upload->KeepFile) {
            $this->file_24->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->file_01->Visible && !$this->file_01->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_01->Upload->FileName)) {
                ...
                $this->file_01->setDbValueDef($rsnew, $this->file_01->Upload->FileName, "", false);
            }
        }
        if ($this->file_02->Visible && !$this->file_02->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_02->Upload->FileName)) {
                ...
                $this->file_02->setDbValueDef($rsnew, $this->file_02->Upload->FileName, "", false);
            }
        }
        if ($this->file_03->Visible && !$this->file_03->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_03->Upload->FileName)) {
                ...
                $this->file_03->setDbValueDef($rsnew, $this->file_03->Upload->FileName, "", false);
            }
        }
        if ($this->file_04->Visible && !$this->file_04->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_04->Upload->FileName)) {
                ...
                $this->file_04->setDbValueDef($rsnew, $this->file_04->Upload->FileName, "", false);
            }
        }
        if ($this->file_05->Visible && !$this->file_05->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_05->Upload->FileName)) {
                ...
                $this->file_05->setDbValueDef($rsnew, $this->file_05->Upload->FileName, "", false);
            }
        }
        if ($this->file_06->Visible && !$this->file_06->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_06->Upload->FileName)) {
                ...
                $this->file_06->setDbValueDef($rsnew, $this->file_06->Upload->FileName, "", false);
            }
        }
        if ($this->file_07->Visible && !$this->file_07->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_07->Upload->FileName)) {
                ...
                $this->file_07->setDbValueDef($rsnew, $this->file_07->Upload->FileName, "", false);
            }
        }
        if ($this->file_08->Visible && !$this->file_08->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_08->Upload->FileName)) {
                ...
                $this->file_08->setDbValueDef($rsnew, $this->file_08->Upload->FileName, "", false);
            }
        }
        if ($this->file_09->Visible && !$this->file_09->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_09->Upload->FileName)) {
                ...
                $this->file_09->setDbValueDef($rsnew, $this->file_09->Upload->FileName, "", false);
            }
        }
        if ($this->file_10->Visible && !$this->file_10->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_10->Upload->FileName)) {
                ...
                $this->file_10->setDbValueDef($rsnew, $this->file_10->Upload->FileName, "", false);
            }
        }
        if ($this->file_11->Visible && !$this->file_11->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_11->Upload->FileName)) {
                ...
                $this->file_11->setDbValueDef($rsnew, $this->file_11->Upload->FileName, "", false);
            }
        }
        if ($this->file_12->Visible && !$this->file_12->Upload->KeepFile) {
        ...
        if ($this->file_14->Visible && !$this->file_14->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_14->Upload->FileName)) {
                ...
                $this->file_14->setDbValueDef($rsnew, $this->file_14->Upload->FileName, "", false);
            }
        }
        if ($this->file_15->Visible && !$this->file_15->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_15->Upload->FileName)) {
                ...
                $this->file_15->setDbValueDef($rsnew, $this->file_15->Upload->FileName, "", false);
            }
        }
        if ($this->file_16->Visible && !$this->file_16->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_16->Upload->FileName)) {
                ...
                $this->file_16->setDbValueDef($rsnew, $this->file_16->Upload->FileName, "", false);
            }
        }
        if ($this->file_17->Visible && !$this->file_17->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_17->Upload->FileName)) {
                ...
                $this->file_17->setDbValueDef($rsnew, $this->file_17->Upload->FileName, "", false);
            }
        }
        if ($this->file_18->Visible && !$this->file_18->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_18->Upload->FileName)) {
                ...
                $this->file_18->setDbValueDef($rsnew, $this->file_18->Upload->FileName, "", false);
            }
        }
        if ($this->file_19->Visible && !$this->file_19->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_19->Upload->FileName)) {
                ...
                $this->file_19->setDbValueDef($rsnew, $this->file_19->Upload->FileName, "", false);
            }
        }
        if ($this->file_20->Visible && !$this->file_20->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_20->Upload->FileName)) {
                ...
                $this->file_20->setDbValueDef($rsnew, $this->file_20->Upload->FileName, "", false);
            }
        }
        if ($this->file_21->Visible && !$this->file_21->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_21->Upload->FileName)) {
                ...
                $this->file_21->setDbValueDef($rsnew, $this->file_21->Upload->FileName, "", false);
            }
        }
        if ($this->file_22->Visible && !$this->file_22->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_22->Upload->FileName)) {
                ...
                $this->file_22->setDbValueDef($rsnew, $this->file_22->Upload->FileName, "", false);
            }
        }
        if ($this->file_23->Visible && !$this->file_23->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_23->Upload->FileName)) {
                ...
                $this->file_23->setDbValueDef($rsnew, $this->file_23->Upload->FileName, "", false);
            }
        }
        if ($this->file_24->Visible && !$this->file_24->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->file_24->Upload->FileName)) {
                ...
                $this->file_24->setDbValueDef($rsnew, $this->file_24->Upload->FileName, "", false);
            }
        }
