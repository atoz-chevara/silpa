...
class UsersList extends Users
{
    ...
    {
        if (!SameString($this->idd_user->OldValue, $this->idd_user->CurrentValue)) {
            return false;
        }
        return true;
    }
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->idd_user->CurrentValue;
    ...
    public function renderListOptions()
    {
        ...
        if ($this->isInlineEditRow()) { // Inline-Edit
            ...
            $opt->Body .= "<input type=\"hidden\" name=\"k" . $this->RowIndex . "_key\" id=\"k" . $this->RowIndex . "_key\" value=\"" . HtmlEncode($this->idd_user->CurrentValue) . "\">";
            return;
        }
        ...
        $opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->idd_user->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->idd_user->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
            ...
            if (!$Security->canAdmin()) { // System admin
                ...
                if ($this->level->ViewValue !== null) { // Load from cache
                    ...
                    if ($curVal == "") {
                        ...
                        $filterWrk = "`id_level`" . SearchString("=", $this->level->CurrentValue, DATATYPE_NUMBER, "");
                    }
    ...
    public function getRowHash(&$rs)
    {
        ...
        $hash .= GetFieldHash($row['level']); // level
        return md5($hash);
    }
