 ...
 * Page class
 */
class PertanggungjawabanView extends Pertanggungjawaban
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PertanggungjawabanView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("idd_evaluasi") ?? Route("idd_evaluasi")) !== null) {
                ...
                $returnUrl = "pertanggungjawabanlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "pertanggungjawabanlist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "pertanggungjawabanlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
