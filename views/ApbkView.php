...
loadjs.ready("head", function () {
    ...
    fapbkview = currentForm = new ew.Form("fapbkview", "view");
    loadjs.done("fapbkview");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fapbkview" id="fapbkview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->idd_evaluasi->Visible) { // idd_evaluasi ?>
    <tr id="r_idd_evaluasi">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_idd_evaluasi"><?= $Page->idd_evaluasi->caption() ?></span></td>
        <td data-name="idd_evaluasi" <?= $Page->idd_evaluasi->cellAttributes() ?>>
<span id="el_apbk_idd_evaluasi">
...
<?php if ($Page->tanggal->Visible) { // tanggal ?>
    <tr id="r_tanggal">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_tanggal"><?= $Page->tanggal->caption() ?></span></td>
...
<?php if ($Page->kd_satker->Visible) { // kd_satker ?>
    <tr id="r_kd_satker">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_kd_satker"><?= $Page->kd_satker->caption() ?></span></td>
...
<?php if ($Page->idd_tahapan->Visible) { // idd_tahapan ?>
    <tr id="r_idd_tahapan">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_idd_tahapan"><?= $Page->idd_tahapan->caption() ?></span></td>
...
<?php if ($Page->tahun_anggaran->Visible) { // tahun_anggaran ?>
    <tr id="r_tahun_anggaran">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_tahun_anggaran"><?= $Page->tahun_anggaran->caption() ?></span></td>
...
<?php if ($Page->idd_wilayah->Visible) { // idd_wilayah ?>
    <tr id="r_idd_wilayah">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_idd_wilayah"><?= $Page->idd_wilayah->caption() ?></span></td>
...
<?php if ($Page->file_01->Visible) { // file_01 ?>
    <tr id="r_file_01">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_01"><?= $Page->file_01->caption() ?></span></td>
...
<?php if ($Page->file_02->Visible) { // file_02 ?>
    <tr id="r_file_02">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_02"><?= $Page->file_02->caption() ?></span></td>
...
<?php if ($Page->file_03->Visible) { // file_03 ?>
    <tr id="r_file_03">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_03"><?= $Page->file_03->caption() ?></span></td>
...
<?php if ($Page->file_04->Visible) { // file_04 ?>
    <tr id="r_file_04">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_04"><?= $Page->file_04->caption() ?></span></td>
...
<?php if ($Page->file_05->Visible) { // file_05 ?>
    <tr id="r_file_05">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_05"><?= $Page->file_05->caption() ?></span></td>
...
<?php if ($Page->file_06->Visible) { // file_06 ?>
    <tr id="r_file_06">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_06"><?= $Page->file_06->caption() ?></span></td>
...
<?php if ($Page->file_07->Visible) { // file_07 ?>
    <tr id="r_file_07">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_07"><?= $Page->file_07->caption() ?></span></td>
...
<?php if ($Page->file_08->Visible) { // file_08 ?>
    <tr id="r_file_08">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_08"><?= $Page->file_08->caption() ?></span></td>
...
<?php if ($Page->file_09->Visible) { // file_09 ?>
    <tr id="r_file_09">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_09"><?= $Page->file_09->caption() ?></span></td>
...
<?php if ($Page->file_10->Visible) { // file_10 ?>
    <tr id="r_file_10">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_10"><?= $Page->file_10->caption() ?></span></td>
...
<?php if ($Page->file_11->Visible) { // file_11 ?>
    <tr id="r_file_11">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_11"><?= $Page->file_11->caption() ?></span></td>
...
<?php if ($Page->file_12->Visible) { // file_12 ?>
    <tr id="r_file_12">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_12"><?= $Page->file_12->caption() ?></span></td>
...
<?php if ($Page->file_13->Visible) { // file_13 ?>
    <tr id="r_file_13">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_13"><?= $Page->file_13->caption() ?></span></td>
...
<?php if ($Page->file_14->Visible) { // file_14 ?>
    <tr id="r_file_14">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_14"><?= $Page->file_14->caption() ?></span></td>
...
<?php if ($Page->file_15->Visible) { // file_15 ?>
    <tr id="r_file_15">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_15"><?= $Page->file_15->caption() ?></span></td>
...
<?php if ($Page->file_16->Visible) { // file_16 ?>
    <tr id="r_file_16">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_16"><?= $Page->file_16->caption() ?></span></td>
...
<?php if ($Page->file_17->Visible) { // file_17 ?>
    <tr id="r_file_17">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_17"><?= $Page->file_17->caption() ?></span></td>
...
<?php if ($Page->file_18->Visible) { // file_18 ?>
    <tr id="r_file_18">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_18"><?= $Page->file_18->caption() ?></span></td>
...
<?php if ($Page->file_19->Visible) { // file_19 ?>
    <tr id="r_file_19">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_19"><?= $Page->file_19->caption() ?></span></td>
...
<?php if ($Page->file_20->Visible) { // file_20 ?>
    <tr id="r_file_20">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_20"><?= $Page->file_20->caption() ?></span></td>
...
<?php if ($Page->file_21->Visible) { // file_21 ?>
    <tr id="r_file_21">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_21"><?= $Page->file_21->caption() ?></span></td>
...
<?php if ($Page->file_22->Visible) { // file_22 ?>
    <tr id="r_file_22">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_22"><?= $Page->file_22->caption() ?></span></td>
...
<?php if ($Page->file_23->Visible) { // file_23 ?>
    <tr id="r_file_23">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_23"><?= $Page->file_23->caption() ?></span></td>
...
<?php if ($Page->file_24->Visible) { // file_24 ?>
    <tr id="r_file_24">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_file_24"><?= $Page->file_24->caption() ?></span></td>
...
<?php if ($Page->status->Visible) { // status ?>
    <tr id="r_status">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_status"><?= $Page->status->caption() ?></span></td>
...
<?php if ($Page->idd_user->Visible) { // idd_user ?>
    <tr id="r_idd_user">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_apbk_idd_user"><?= $Page->idd_user->caption() ?></span></td>
