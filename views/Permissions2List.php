...
<?php if ($Page->table_name->Visible) { // table_name ?>
        <th data-name="table_name" class="<?= $Page->table_name->headerCellClass() ?>"><div id="elh_permissions2_table_name" class="permissions2_table_name"><?= $Page->renderSort($Page->table_name) ?></div></th>
<?php } ?>
<?php if ($Page->id_level->Visible) { // id_level ?>
        <th data-name="id_level" class="<?= $Page->id_level->headerCellClass() ?>"><div id="elh_permissions2_id_level" class="permissions2_id_level"><?= $Page->renderSort($Page->id_level) ?></div></th>
<?php } ?>
<?php if ($Page->_permission->Visible) { // permission ?>
        <th data-name="_permission" class="<?= $Page->_permission->headerCellClass() ?>"><div id="elh_permissions2__permission" class="permissions2__permission"><?= $Page->renderSort($Page->_permission) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_permissions2_table_name">
...
<span id="el<?= $Page->RowCount ?>_permissions2_id_level">
...
<span id="el<?= $Page->RowCount ?>_permissions2__permission">
