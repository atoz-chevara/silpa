...
// Page object
$PertanggungjawabanAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpertanggungjawabanadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fpertanggungjawabanadd = currentForm = new ew.Form("fpertanggungjawabanadd", "add");
    ...
    // Validate form
    fpertanggungjawabanadd.validate = function () {
    ...
    // Form_CustomValidate
    fpertanggungjawabanadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
$Page->showMessage();
?>
<form name="fpertanggungjawabanadd" id="fpertanggungjawabanadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
