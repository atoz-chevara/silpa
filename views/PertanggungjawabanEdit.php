...
<input type="hidden" name="fa_x_rqanun_apbkpert" id= "fa_x_rqanun_apbkpert" value="<?= (Post("fa_x_rqanun_apbkpert") == "0") ? "0" : "1" ?>">
...
<input type="hidden" name="fa_x_rperbup_apbkpert" id= "fa_x_rperbup_apbkpert" value="<?= (Post("fa_x_rperbup_apbkpert") == "0") ? "0" : "1" ?>">
...
<input type="hidden" name="fa_x_pbkdd_apbkpert" id= "fa_x_pbkdd_apbkpert" value="<?= (Post("fa_x_pbkdd_apbkpert") == "0") ? "0" : "1" ?>">
