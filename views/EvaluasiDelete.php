...
<?php if ($Page->file_01->Visible) { // file_01 ?>
        <th class="<?= $Page->file_01->headerCellClass() ?>"><span id="elh_evaluasi_file_01" class="evaluasi_file_01"><?= $Page->file_01->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_02->Visible) { // file_02 ?>
        <th class="<?= $Page->file_02->headerCellClass() ?>"><span id="elh_evaluasi_file_02" class="evaluasi_file_02"><?= $Page->file_02->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_03->Visible) { // file_03 ?>
        <th class="<?= $Page->file_03->headerCellClass() ?>"><span id="elh_evaluasi_file_03" class="evaluasi_file_03"><?= $Page->file_03->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_04->Visible) { // file_04 ?>
        <th class="<?= $Page->file_04->headerCellClass() ?>"><span id="elh_evaluasi_file_04" class="evaluasi_file_04"><?= $Page->file_04->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_05->Visible) { // file_05 ?>
        <th class="<?= $Page->file_05->headerCellClass() ?>"><span id="elh_evaluasi_file_05" class="evaluasi_file_05"><?= $Page->file_05->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_06->Visible) { // file_06 ?>
        <th class="<?= $Page->file_06->headerCellClass() ?>"><span id="elh_evaluasi_file_06" class="evaluasi_file_06"><?= $Page->file_06->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_07->Visible) { // file_07 ?>
        <th class="<?= $Page->file_07->headerCellClass() ?>"><span id="elh_evaluasi_file_07" class="evaluasi_file_07"><?= $Page->file_07->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_08->Visible) { // file_08 ?>
        <th class="<?= $Page->file_08->headerCellClass() ?>"><span id="elh_evaluasi_file_08" class="evaluasi_file_08"><?= $Page->file_08->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_09->Visible) { // file_09 ?>
        <th class="<?= $Page->file_09->headerCellClass() ?>"><span id="elh_evaluasi_file_09" class="evaluasi_file_09"><?= $Page->file_09->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_10->Visible) { // file_10 ?>
        <th class="<?= $Page->file_10->headerCellClass() ?>"><span id="elh_evaluasi_file_10" class="evaluasi_file_10"><?= $Page->file_10->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_11->Visible) { // file_11 ?>
        <th class="<?= $Page->file_11->headerCellClass() ?>"><span id="elh_evaluasi_file_11" class="evaluasi_file_11"><?= $Page->file_11->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_12->Visible) { // file_12 ?>
        <th class="<?= $Page->file_12->headerCellClass() ?>"><span id="elh_evaluasi_file_12" class="evaluasi_file_12"><?= $Page->file_12->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_13->Visible) { // file_13 ?>
        <th class="<?= $Page->file_13->headerCellClass() ?>"><span id="elh_evaluasi_file_13" class="evaluasi_file_13"><?= $Page->file_13->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_14->Visible) { // file_14 ?>
        <th class="<?= $Page->file_14->headerCellClass() ?>"><span id="elh_evaluasi_file_14" class="evaluasi_file_14"><?= $Page->file_14->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_15->Visible) { // file_15 ?>
        <th class="<?= $Page->file_15->headerCellClass() ?>"><span id="elh_evaluasi_file_15" class="evaluasi_file_15"><?= $Page->file_15->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_16->Visible) { // file_16 ?>
        <th class="<?= $Page->file_16->headerCellClass() ?>"><span id="elh_evaluasi_file_16" class="evaluasi_file_16"><?= $Page->file_16->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_17->Visible) { // file_17 ?>
        <th class="<?= $Page->file_17->headerCellClass() ?>"><span id="elh_evaluasi_file_17" class="evaluasi_file_17"><?= $Page->file_17->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_18->Visible) { // file_18 ?>
        <th class="<?= $Page->file_18->headerCellClass() ?>"><span id="elh_evaluasi_file_18" class="evaluasi_file_18"><?= $Page->file_18->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_19->Visible) { // file_19 ?>
        <th class="<?= $Page->file_19->headerCellClass() ?>"><span id="elh_evaluasi_file_19" class="evaluasi_file_19"><?= $Page->file_19->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_20->Visible) { // file_20 ?>
        <th class="<?= $Page->file_20->headerCellClass() ?>"><span id="elh_evaluasi_file_20" class="evaluasi_file_20"><?= $Page->file_20->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_21->Visible) { // file_21 ?>
        <th class="<?= $Page->file_21->headerCellClass() ?>"><span id="elh_evaluasi_file_21" class="evaluasi_file_21"><?= $Page->file_21->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_22->Visible) { // file_22 ?>
        <th class="<?= $Page->file_22->headerCellClass() ?>"><span id="elh_evaluasi_file_22" class="evaluasi_file_22"><?= $Page->file_22->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_23->Visible) { // file_23 ?>
        <th class="<?= $Page->file_23->headerCellClass() ?>"><span id="elh_evaluasi_file_23" class="evaluasi_file_23"><?= $Page->file_23->caption() ?></span></th>
<?php } ?>
<?php if ($Page->file_24->Visible) { // file_24 ?>
        <th class="<?= $Page->file_24->headerCellClass() ?>"><span id="elh_evaluasi_file_24" class="evaluasi_file_24"><?= $Page->file_24->caption() ?></span></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_01" class="evaluasi_file_01">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_02" class="evaluasi_file_02">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_03" class="evaluasi_file_03">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_04" class="evaluasi_file_04">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_05" class="evaluasi_file_05">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_06" class="evaluasi_file_06">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_07" class="evaluasi_file_07">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_08" class="evaluasi_file_08">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_09" class="evaluasi_file_09">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_10" class="evaluasi_file_10">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_11" class="evaluasi_file_11">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_12" class="evaluasi_file_12">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_13" class="evaluasi_file_13">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_14" class="evaluasi_file_14">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_15" class="evaluasi_file_15">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_16" class="evaluasi_file_16">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_17" class="evaluasi_file_17">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_18" class="evaluasi_file_18">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_19" class="evaluasi_file_19">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_20" class="evaluasi_file_20">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_21" class="evaluasi_file_21">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_22" class="evaluasi_file_22">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_23" class="evaluasi_file_23">
...
<span id="el<?= $Page->RowCount ?>_evaluasi_file_24" class="evaluasi_file_24">
