...
loadjs.ready("head", function () {
    ...
    fevaluatorsedit = currentForm = new ew.Form("fevaluatorsedit", "edit");
    ...
    // Validate form
    fevaluatorsedit.validate = function () {
    ...
    // Form_CustomValidate
    fevaluatorsedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fevaluatorsedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fevaluatorsedit.lists.wilayah = <?= $Page->wilayah->toClientList($Page) ?>;
    fevaluatorsedit.lists.idd_user = <?= $Page->idd_user->toClientList($Page) ?>;
    loadjs.done("fevaluatorsedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fevaluatorsedit" id="fevaluatorsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php } ?>
    ...
    <input type="hidden" data-table="evaluators" data-field="x_idd_evaluator" data-hidden="1" name="x_idd_evaluator" id="x_idd_evaluator" value="<?= HtmlEncode($Page->idd_evaluator->CurrentValue) ?>">
<?php if (!$Page->IsModal) { ?>
