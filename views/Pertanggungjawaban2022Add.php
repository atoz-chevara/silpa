...
loadjs.ready("head", function () {
    ...
    fpertanggungjawaban2022add.lists.idd_user = <?= $Page->idd_user->toClientList($Page) ?>;
...
<script>
loadjs.ready(["fpertanggungjawaban2022add", "datetimepicker"], function() {
    ew.createDateTimePicker("fpertanggungjawaban2022add", "x_tanggal", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
