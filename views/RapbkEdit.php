...
loadjs.ready("head", function () {
    ...
    frapbkedit = currentForm = new ew.Form("frapbkedit", "edit");
    ...
    // Form_CustomValidate
    frapbkedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    frapbkedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    frapbkedit.lists.kd_satker = <?= $Page->kd_satker->toClientList($Page) ?>;
    frapbkedit.lists.idd_tahapan = <?= $Page->idd_tahapan->toClientList($Page) ?>;
    frapbkedit.lists.tahun_anggaran = <?= $Page->tahun_anggaran->toClientList($Page) ?>;
    frapbkedit.lists.status = <?= $Page->status->toClientList($Page) ?>;
    frapbkedit.lists.idd_user = <?= $Page->idd_user->toClientList($Page) ?>;
    loadjs.done("frapbkedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="frapbkedit" id="frapbkedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->idd_evaluasi->Visible) { // idd_evaluasi ?>
    <div id="r_idd_evaluasi" class="form-group row">
        <label id="elh_rapbk_idd_evaluasi" class="<?= $Page->LeftColumnClass ?>"><?= $Page->idd_evaluasi->caption() ?><?= $Page->idd_evaluasi->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="hidden" data-table="rapbk" data-field="x_idd_evaluasi" data-hidden="1" name="x_idd_evaluasi" id="x_idd_evaluasi" value="<?= HtmlEncode($Page->idd_evaluasi->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["frapbkedit", "datetimepicker"], function() {
    ew.createDateTimePicker("frapbkedit", "x_tanggal", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<input type="hidden" name="fa_x_file_11" id= "fa_x_file_11" value="<?= (Post("fa_x_file_11") == "0") ? "0" : "1" ?>">
...
<input type="hidden" name="fa_x_file_12" id= "fa_x_file_12" value="<?= (Post("fa_x_file_12") == "0") ? "0" : "1" ?>">
...
<input type="hidden" name="fa_x_file_13" id= "fa_x_file_13" value="<?= (Post("fa_x_file_13") == "0") ? "0" : "1" ?>">
...
<input type="hidden" name="fa_x_file_14" id= "fa_x_file_14" value="<?= (Post("fa_x_file_14") == "0") ? "0" : "1" ?>">
...
<input type="hidden" name="fa_x_file_15" id= "fa_x_file_15" value="<?= (Post("fa_x_file_15") == "0") ? "0" : "1" ?>">
...
<input type="hidden" name="fa_x_file_16" id= "fa_x_file_16" value="<?= (Post("fa_x_file_16") == "0") ? "0" : "1" ?>">
...
<input type="hidden" name="fa_x_file_17" id= "fa_x_file_17" value="<?= (Post("fa_x_file_17") == "0") ? "0" : "1" ?>">
...
<input type="hidden" name="fa_x_file_18" id= "fa_x_file_18" value="<?= (Post("fa_x_file_18") == "0") ? "0" : "1" ?>">
...
<input type="hidden" name="fa_x_file_19" id= "fa_x_file_19" value="<?= (Post("fa_x_file_19") == "0") ? "0" : "1" ?>">
...
<input type="hidden" name="fa_x_file_20" id= "fa_x_file_20" value="<?= (Post("fa_x_file_20") == "0") ? "0" : "1" ?>">
...
<input type="hidden" name="fa_x_file_21" id= "fa_x_file_21" value="<?= (Post("fa_x_file_21") == "0") ? "0" : "1" ?>">
...
<input type="hidden" name="fa_x_file_22" id= "fa_x_file_22" value="<?= (Post("fa_x_file_22") == "0") ? "0" : "1" ?>">
...
<input type="hidden" name="fa_x_file_23" id= "fa_x_file_23" value="<?= (Post("fa_x_file_23") == "0") ? "0" : "1" ?>">
...
<input type="hidden" name="fa_x_file_24" id= "fa_x_file_24" value="<?= (Post("fa_x_file_24") == "0") ? "0" : "1" ?>">
