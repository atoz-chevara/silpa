    ...
    <nav class="<?= Config("NAVBAR_CLASS") ?>">
        ...
        <ul id="ew-navbar" class="navbar-nav">
            ...
            <a class="navbar-brand d-none" href="#"  onclick="return false;">
                <img src="<?= GetUrl("images/logo_aplikasi.png") ?>" alt="" class="brand-image ew-brand-image">
            </a>
        </ul>
        <!-- Right navbar links -->
...
?>
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
    	<div class="image"> <img src="<?= GetUrl("images/user2-160x160.jpg") ?>" class="img-circle elevation-2" alt="User Image"> </div>
